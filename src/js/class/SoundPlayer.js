var Sound = function ( sources, volume, loop) {
		...
		this.resetVolume = function () {console.log(this.initialVolume);
...
var soundPadExplosion = new Sound ( ['src/medias/sounds/pad_explosion.ogg'],0.7,false);
