...
define(["require", "exports", "./alien"], function (require, exports, alien_1) {
    "use strict";
    var AlienBonus = (function (_super) {
        __extends(AlienBonus, _super);
        function AlienBonus() {
            _super.call(this, alien_1.Alien.type.bonus, new THREE.Vector3(AlienBonus.increment, 0.0, AlienBonus.increment), new THREE.Vector3(10.0, 21.0, 10.0));
        ...
        AlienBonus.prototype.animate = function () {
            if ((Date.now() - this.lastMeshSwitch) > alien_1.Alien.meshSwitchDelay) {
                this.switchMesh();
